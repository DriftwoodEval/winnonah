...
> Everything in this section is correct and true, however, I'm still working on getting the screenshots put in
...
Changing the size of widgets may result in the automatic rearraging of other widgets, especially if the widget below the resized widget now fits next to it, or if the resized widget ends up being too large for other widgets next to it.

![](images/resize_widget.gif)
