...
See [Client Record Lifecycle](/docs/documentation/client-lifecycle) for how a "Notes Only" client gets created in the first place, and exactly how these suggestions get computed.
