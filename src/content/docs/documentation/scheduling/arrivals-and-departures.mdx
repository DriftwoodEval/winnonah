...
**Evaluators should be marked as "In for the Day" first thing when they arrive.** This is done by clicking on the "In for the Day" button directly across from the specific evaluators name, and clicking the "Save" button.
