...
const DateTimePicker: React.FC<DateTimePickerProps> = ({
	...
	return (
		// Changed the parent container to use flex-row for layout
		<div className="flex flex-row gap-2 w-full">
			...
			<Popover open={open} onOpenChange={setOpen}>
				<PopoverTrigger asChild>
					<Button
						variant="outline"
						className={cn(
							// 💡 FIX 1: Ensure date button has a minimum width
			...
			<Input
				...
				step="60"
				// 💡 FIX 2: Explicitly set a minimum width and prevent shrinking
