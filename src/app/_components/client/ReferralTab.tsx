					...
					<div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={(value) => value && handleAsdAdhdChange(value)}
							...
							<div className="flex flex-col gap-2 rounded-lg bg-muted p-4 text-sm">
								{isSpanish ? (
									...
									<p>
										...
										received your referral and wanted to ask you some questions
								...
								<div className="space-y-4">
									...
									{followedByBabyNet === "yes" && (
										<div className="flex items-center justify-between rounded-lg bg-muted p-4 text-sm">
											{isSpanish ? (
												<p>
													Le estoy enviando un mensaje de texto, por favor
													envíelo a su especialista en intervención temprana.
												</p>
											) : (
												<p>
													I'm sending you a text, please forward it to your
							...
							<>
								...
								<div className="space-y-4">
									<div className="flex flex-col gap-2 rounded-lg bg-secondary p-4 text-secondary-foreground text-sm">
										...
										<p>
											...
											chair icon. If the client's email is different, update it
											in TherapyAppointment. Then, click{" "}
									...
									<div className="flex flex-col gap-2 rounded-lg bg-muted p-4 text-sm">
										<p>
											I'd like you to create your account while we're on the
											phone together. You should receive an email from
										...
										<p>
											Once you're in the portal, there will be documents to
											sign. They usually will pop up as part of the sign-up
											process. Please complete them so we can move forward.
										</p>

										{showSchoolQuestion && (
											<p>
												We will request records from the school district and
												then be in touch to discuss next steps.
											</p>
										)}
										...
										{isAdhd ? (
											<>
												<p>
													...
													upper right hand corner of the screen. You will also
													get an email telling you that you have a new message.
												</p>
												<p>
											...
											<>
												<p>
													Soon, we will send you questionnaires to complete.
													...
													video call/Telehealth. That appointment will tell us
													if we are moving ahead with the evaluation. If so, we
													will request approval from insurance before sending
													more questionnaires in order to get the in-person
													comprehensive evaluation scheduled.
												</p>
												<p>
													This process takes approximately 4-6 months to
													complete. It is very important that we have your
													cooperation with this process; if we have to wait for
													you to complete something that delays everything.
								...
								<div className="flex flex-col gap-2 rounded-lg bg-secondary p-4 text-secondary-foreground text-sm">
									...
									<p className="font-bold">
										...
										right. Go to the client's TherapyAppointment page by
										clicking the chair icon and send them the following message:
									</p>
								...
								{!isAdhd ? (
									<>
										<p>
											...
											español. Una vez firmados, le enviaremos un cuestionario,
											el cual consiste en una lista de preguntas que deberá
											responder, también en español. Una vez completados, se le
											asignará un intérprete. Esta persona nos ayudará a
											programar su cita en nuestra oficina. Por lo general, en
											esa cita determinaremos si vamos a proceder con la
											evaluación. De ser así, solicitaremos el permiso de su
											compañía de seguros médico. Una vez recibida dicho
											permiso, le enviaremos más cuestionarios. Cuando estos
											estén completos, nuestro intérprete se comunicará con
											usted para programar la evaluación completa en persona.
										</p>
										{showSchoolQuestion && (
										...
										<p>
											...
											complete alguna tarea, esto retrasará todo el
											procedimiento. Le pedimos paciencia, ya que nuestra
											intención es ayudar al mayor número posible de personas en
											todo el estado.
										</p>
									</>
								) : (
									<p>
										Pronto le enviaremos por correo electrónico algunos
										formularios de consentimiento y relacionados con la
										normativa HIPAA para que nos los firme; estos estarán en
										español. Una vez firmados, le enviaremos un cuestionario
										—que consiste en una lista de preguntas para responder,
										también en español. Una vez completado, se le asignará un
										intérprete, quien nos ayudará a programar su cita en nuestra
										oficina.{" "}
										{showSchoolQuestion && (
											<span>
										...
										{isLoadingPreview ? (
											...
											<div className="mt-2 grid grid-cols-2 items-center gap-x-4 gap-y-1 text-xs">
												...
												<span className="col-span-2 my-1">
													Additionally, pushing will update this data in the
													EMR:
												</span>
												<span className="font-semibold text-muted-foreground uppercase">
													Records:
