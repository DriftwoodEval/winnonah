	...
	return (
		<Form {...form}>
			...
			>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem className="flex flex-col gap-2">
										...
										<FormDescription>
											This evaluator tells us their out of office times, not
											their in office times.
										</FormDescription>
										<FormControl>
											<Switch
												checked={field.value}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem className="flex flex-col gap-2">
										...
										<FormDescription>
											If the punchlist writer is blank, credit this evaluator
											for report piecework based on their most recent 96136
											appointment.
										</FormDescription>
										<FormControl>
											<Switch
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Optional. If set, clients with an upcoming EVAL appointment
										are moved here instead of the regular Drive Folder.
									</FormDescription>
									<FormMessage />
								</FormItem>
							)}
				...
				<Card>
					<CardHeader>
						<CardTitle>Appointment Types & Durations</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						<FormField
							control={form.control}
									...
									if (checked) {
										...
										if (isRowKey) {
											if (key === "DA") {
												...
												field.onChange(
													field.value.filter((t) => !toRemove.has(t)),
												);
											}
										} else {
						...
						<div className="space-y-2">
							...
							<p className="text-muted-foreground text-xs">
								...
								placeholders show the global default. Leave blank to fall back
								to the default. Disabled rows reflect types this evaluator
								cannot perform. Values are in hours (e.g. 1.5 = 90 min).
							</p>
						</div>
					</CardContent>
				</Card>
