...
#
# Reads state from Cloudflare Worker. Triggers failover.sh if state="failover".
#
# Crontab:
#   * * * * * /bin/bash ~/winnonah/failover/standby-poll.sh >> /var/log/standby-poll.log 2>&1
